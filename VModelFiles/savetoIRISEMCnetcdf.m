...
savefigtag=1;
ncmodelfile='YangETAL_NACratonFWANT_Vs2025.nc';
outparfile='YangETAL_NACratonFWANT_Vs2025.cdl';%[ite_nm, '_dataforIRISEMC.cdl'];

modelid='NACraton-FWANT-Vs2025';
maskrayfile=['RayCoverOutline_',ite_nm,'_40-75s_cutoff10.mat'];
%
master_pars;
depthrange=[0,300];
dlon=0.05;
...
% mvp = smooth3(mvp,'box',[3 3 3]);
% mvs = smooth3(mvs,'box',[7 7 3]);
...
%global attributes.
fprintf(fidout,'\n\n:title = "Shear wave velocity model for the North American midcontinent" ;\n');
fprintf(fidout,':id = "%s" ;\n',modelid);
fprintf(fidout,':model = "%s" ;\n',modelid);
fprintf(fidout,':summary = "Shear wave velocity model for the top 200 km beneath the North');
fprintf(fidout,' American midcontinent from full-wave ambient noise tomogrpahy.";\n');

%
fprintf(fidout,':grid_dim = "3D" ;\n');
fprintf(fidout,':year = "2025" ;\n');
fprintf(fidout,':model_type = "3-D Tomography Earth Model" ;\n');
fprintf(fidout,':model_subtype = "Shear-wave velocity (km/s)" ;\n');
fprintf(fidout,':grid_ref = "latitude_longitude" ;\n');

fprintf(fidout,':keywords = "shear wave velocity, ambient noise tomography, North American midcontinent,');
fprintf(fidout,' lithospheric delamination, basin subsidence, basin termination";\n');

fprintf(fidout,':Conventions = "CF-1.0";\n');
fprintf(fidout,':Metadata_Conventions = "Unidata Dataset Discovery v1.0";\n');
fprintf(fidout,':author_name = "Xiaotao Yang" ;\n');
fprintf(fidout,':author_url = "https://sites.google.com/site/xiaotaoyanggeo" ;\n');
fprintf(fidout,':author_email = "xtyang@purdue.edu OR stcyang@gmail.com" ;\n');
fprintf(fidout,':author_institution = "Purdue University" ;\n');

fprintf(fidout,':acknowledgment = "Model was provided by Xiaotao Yang at Purdue University. ');
fprintf(fidout,' This research was supported by the startup at Purdue University ');
fprintf(fidout,' and NSF award EAR-2319445 to X. Yang and the Lee J. Suttner Professorship ');
fprintf(fidout,' at Indiana University to A. Stevens Goddard. All the seismic data used in this ');
fprintf(fidout,' study were downloaded from EarthScope Data Management Center. The computational ');
fprintf(fidout,' resources used in this study were provided by the Purdue research computing." ;\n');

fprintf(fidout,':reference = "Yang et al., in press" ;\n');
fprintf(fidout,':reference_pid = "doi:TBD" ;\n');
fprintf(fidout,':repository_name = "EMC" ;\n');
fprintf(fidout,':repository_institution = "EarthScope DS" ;\n');
fprintf(fidout,':repository_pid = "doi:10.17611/dp/emc.2025.nacratonfwant.1" ;\n');
fprintf(fidout,':data_revision = "r0.0" ;\n');
fprintf(fidout,':history = "model was produced in 2022, accepted for publication in 2025" ;\n');
fprintf(fidout,':comment = "P-wave model is resolved only for the top 20 km. FWANT iteration: %s" ;\n',ite_nm);
...
fprintf(fidout,':geospatial_vertical_units = "km";\n');
